<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="Microsoft.Cloud.Portal.Service.Mobile.products" %>
<!doctype html>
<html class="no-js">
<head>
    <meta charset="utf-8">
...
<div data-am-widget="titlebar" class="am-titlebar am-titlebar-default">
    <h2 class="am-titlebar-title ">产品开通</h2>
</div>
<!--人员列表开始-->
        ...
        <dd class="am-accordion-bd am-collapse">
            ...
            <div class="am-accordion-content">
                <table class="am-table am-table-bordered">
                    ...
                    <tr>
                        <td class="am-active">企业名称</td>
                        <td>{{ECChName}}</td>
                    </tr>
                    <tr>
                        <td class="am-active">需要授权</td>
                        <td>{{authorize EnableMemberAssign}}</td>
                    </tr>
                    <tr>
                        <td class="am-active">许可总量</td>
                        <td>{{TotalLicense}}</td>
                    </tr>
                    <tr>
                        <td class="am-active">已用数量</td>
                        <td>{{UsedLicense}}</td>
                    </tr>
                    <tr>
...
<script id="sq-toolbar-template" type="text/x-handlebars-template">
    <div class="am-modal-actions-group">
        <ul class="am-list">
            <li class="am-modal-actions-header">修改产品: {{ProductName}}</li>
            <li>
                <a href="javascript:void(0)"><span class="am-icon-play"></span> 开通</a>
            </li>
...
<!--查询产品结束-->
<!--开通产品开始-->
<div class="am-modal" tabindex="-1" id="sq-modal-enable">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <form class="am-form" id="sq-form-enable" data-am-validator>
                ...
                <div class="am-form-group">
                    ...
                    <button type="submit" id="sq-modal-enable-confirm" class="am-btn am-btn-primary ui-btn-static">开通产品</button>
                </div>
            </form>
        </div>
...
<!--回到顶部结束-->
<script src="assets/js/libs/require.js" data-main="assets/js/products" type="application/javascript"></script>
</body>
</html>